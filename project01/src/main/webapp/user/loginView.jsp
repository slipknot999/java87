...
<script type="text/javascript">
	...
	window.onload = function(){
		...
		document.loginForm.userId.focus();
		document.loginForm.userId.onkeydown = function(){
			if(event.keyCode == '13') document.loginForm.password.focus();
		}
		document.loginForm.password.onkeydown = function(){
			if(event.keyCode == '13') fncLogin();
		}
	}
              ...
              <tr> 
                ...
                <td height="30">
                  <input 	type="text" name="userId"  class="ct_input_g" 
                  				style="width:180px; height:19px"  maxLength='50' value="admin"/>          
          		</td>
              ...
              <tr> 
                ...
                <td height="30">                    
                    <input 	type="password" name="password" class="ct_input_g" 
                    				style="width:180px; height:19px"  maxLength="50" value="1234"/>
                </td>
                <td width="20" height="30">&nbsp;</td>
              </tr>
              <tr> 
