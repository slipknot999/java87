...
<script type="text/javascript">
	...
	window.onload = function(){
		...
		document.detailForm.searchKeyword.focus();
		
		if(document.detailForm.searchKeyword.value =="null"){
			document.detailForm.searchKeyword.value=null;
		}else{
			document.detailForm.searchKeyword.value = '${search.searchKeyword }';
		}
		document.detailForm.searchKeyword.onkeydown = function(){
			if(event.keyCode == '13') {
				fncGetUserList('1');
			} 
		}
