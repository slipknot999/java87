...
function resetData() { // 폼리셋
	document.detailForm.reset();
}

function addProduct() { // 등록
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:13px;">
	...
	<tr>
		...
		<td class="ct_write01">
			<input 	type="text" name="prodDetail" class="ct_input_g" 
							style="width:300px; height:50px"  maxLength="30" minLength="6"  />
		</td>
	</tr>
	...
	<tr>
		...
		<td class="ct_write01">
			...
			<img src="../images/ct_icon_date.gif" width="15" height="15" 
										onclick="show_calendar('document.detailForm.manuDate', document.detailForm.manuDate.value)" style="cursor:pointer"
										/>
		</td>
	</tr>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="file" name="fileName" class="ct_input_g" style="width:300px;"  >
		</td>
	</tr>
